...
class Scoreboard:
    ...
    def prep_high_score(self):
        ...
        # center the high score to the center of the screen
    ...
    def margin_top(self):
        self.level_rect = self.level_image.get_rect()
        self.level_rect_height = self.level_rect.height
        self.score_rect = self.score_image.get_rect()
        self.score_rect_height = self.score_rect.height
        self.marge_top = self.level_rect_height + self.score_rect_height
